...
| MVP-DASH-005 | System Health | FR-SELF-001 | NeuralDB 자체 상태 (DB/Valkey/Celery UP/DOWN) |
...
| Apache Kafka | Phase 3+ (A2A 에이전트 이벤트 스트리밍). MVP는 Celery + Valkey로 비동기 처리 |
