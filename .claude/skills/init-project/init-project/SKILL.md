---
name: init-project
description: Initialize the AIDbChecker project structure with all required directories, configs, and boilerplate based on the PRD v3.2, TECH_STACK.md, and MVP.md. React 18 + Vite (FE), Python/FastAPI (BE), PostgreSQL 16 (DB). Uses uv for Python package management.
