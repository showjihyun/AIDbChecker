---
name: gen-component
description: Generate React 18 + Vite frontend components from Stitch design screens. References the FRONTEND_DESIGN.md design tokens, color palette, typography, and component patterns to produce pixel-accurate Tailwind CSS components. No Next.js — this is a SPA project (ADR-005).
