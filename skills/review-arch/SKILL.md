---
name: review-arch
description: Review code for architecture compliance against the NeuralDB PRD v3.2, TECH_STACK.md, and AGENTS.md. Checks module boundaries, dependency rules (FastAPI/SQLAlchemy/React only), license compliance (MIT/Apache/BSD), design token consistency, and uv usage.
